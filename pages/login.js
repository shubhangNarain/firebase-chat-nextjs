        ...
        <div className='flex items-center flex-col'>
            ...
            <form className='flex flex-col items-center gap-3 w-[500px] mt-5'>
                <input
                    type='email'
                    placeholder='Email'
                    className='w-full h-14 bg-c2 rounded-md outline-none border-none px-5 text-c3'
                    autoComplete='off'
                />
                <input
                    type='password'
                ...
                <button className='mt-4 w-full h-14 rounded-xl outline-none 
                text-base font-semibold bg-gradient-to-r from-indigo-500
